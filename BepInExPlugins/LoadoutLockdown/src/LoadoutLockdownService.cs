...
internal class LoadoutLockdownService
{
    ...
    public bool IsOwnSlotWasted(Entity entity)
    {
        if (!HasOwnSlot(entity))
        {
            return false;
        }
        // todo: implement
    ...
    public bool TryFindWastedWeaponSlot(Entity entity, out int slotIndex)
    {
        var maxSlotIndex = _config.WeaponSlots - 1;
