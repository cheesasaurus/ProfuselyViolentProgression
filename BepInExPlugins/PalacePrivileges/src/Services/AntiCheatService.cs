...
public class AntiCheatService
{
    ...
    public void Detected_PrisonBreaker(UserModel actingUser)
    {
        _log.LogWarning($"PrisonBreaker detected: steam:{actingUser.PlatformId} character:{actingUser.CharacterName}");
    }
