...
public enum DoorPrivs : long
{
    ...
    Wide = 1 << 3,
    Fence = 1 << 4,
    Palisade = 1 << 5, // PalisadesBuildMenuGroup ? TM_Castle_Wall_Door_Palisade_Tier01 ?
    ...
    ThinNocturalOpulenceRed = 1 << 15,
    ThinNocturalOpulenceOrange = 1 << 16,
    ThinNocturalOpulenceYellow = 1 << 17,
    ThinNocturalOpulenceGreen = 1 << 18,
    ThinNocturalOpulenceGreenLight = 1 << 19, // todo: actual color name. light green
    ThinNocturalOpulenceBlueLight = 1 << 20, // todo: actual color name. light blue
    ThinNocturalOpulenceBlue = 1 << 21,
    ThinNocturalOpulencePurple = 1 << 22,
    ThinNocturalOpulencePink = 1 << 23,
    ThinNocturalOpulenceWhite = 1 << 24,
    ThinNocturalOpulenceGrey = 1 << 25,
    ThinNocturalOpulenceBlack = 1 << 26,
