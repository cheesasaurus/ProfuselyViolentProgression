...
public class SCTService
{
    ...
    public static float3 ColorRed = new float3(1, 0, 0);
    public static float3 ColorDarkRed = new float3(0.9f, 0, 0);
    ...
    public void CreateSCTMessage(Entity character, AssetGuid messageGuid, float3 color)
    {
        ...
        CreateSCTMessage(translation.Value, character, messageGuid, color);
    }
